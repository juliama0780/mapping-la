...
Is this how the data should be organized? There's clearly distinctive vaiables (age, race, veteran's) that perhaps we can reorder the data to be longer or split into multiple dfs.
